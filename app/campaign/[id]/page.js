...
const CampaignDetails = () => {
  ...
  const handleSelectTier = tierIndex => {
    const address = campaignData?.address || campaignId;
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-amber-700">
                      Use the &quot;Select&quot; button to choose which tiers
                      will appear in the funding popup for donors. Selected
                      tiers are highlighted in blue. Your selections are saved
              ...
              {campaignData.tiers && campaignData.tiers.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="bg-gradient-to-br from-[#51256b]/10 to-[#19d8f7]/10 rounded-full w-24 h-24 mx-auto mb-6 flex items-center justify-content-center">
