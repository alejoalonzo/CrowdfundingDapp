...
contract Crowdfunding {
    ...
    modifier campaignOpen() {
        require(state == CampaignState.Active, "Campaign state is not active ");
        _;
    }
    ...
    function addTier(string memory _name, uint256 _amount) public onlyOwner {
        require(_amount > 0, "Must fund amount higher than 0.");
        tiers.push(Tier(_name, _amount, 0));
    }

    function removeTier(uint256 _index) public onlyOwner {
        require(_index < tiers.length, "Invalid tier index, Tier do not exist");
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0, "No balance to withdrow");
    ...
    function refund() public {
        ...
        require(
            ...
            "Campaign must be failed to refund"
        );
